...
class Bee {
  constructor(beeNumber) {
    // the HTMP element corresponding to the img bee
...
function createBeeImg(wNum) {
  ...
  img.style.top = y + "px"; //return the img object
  return img;
}
// getRandom int function
...
function updateBees() {
  ...
  moveBees();
  // control refresh period by user Refesh Period input
...
function overlap(element1, element2) {
  ...
  intersectArea = x_intersect * y_intersect; //if intersection is nil no hit
